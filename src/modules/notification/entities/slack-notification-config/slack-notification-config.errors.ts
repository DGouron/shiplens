...
export class WebhookNotConfiguredError extends BusinessRuleViolation {
  constructor() {
    super(
...
export class InvalidWebhookUrlError extends BusinessRuleViolation {
  constructor() {
    super("L'adresse du webhook Slack est invalide. Veuillez vérifier le format.");
  }
}
