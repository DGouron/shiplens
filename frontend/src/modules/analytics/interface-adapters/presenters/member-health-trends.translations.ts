...
export interface MemberHealthTrendsTranslations {
  pageTitle: string;
...
> = {
  en: {
    ...
    healthSignalsSubtitle:
      'Health signals computed over the last {cycleCount} completed cycles',
  ...
  fr: {
    ...
    healthSignalsSubtitle:
      'Signaux de sante calcules sur les {cycleCount} derniers cycles termines',
